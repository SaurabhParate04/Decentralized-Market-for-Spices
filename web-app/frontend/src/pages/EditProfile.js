...
export const EditProfile = (props) => {
  ...
  const { firstname, lastname, username, email, addressl1, addressl2, landmark, phoneNumber, pincode } = userProfile;
    ...
    try {
      ...
      const response = await fetch(url, {
        ...
        headers: {
          ...
          address: userProfile.addressl1 + ' ' + userProfile.addressl2,
                  ...
                  <div className="row">
                    ...
                    <div className="mb-1 col-md-12">
                      ...
                      <input
                        ...
                        className="form-control disable-highlight"
                        id="age"
                        defaultValue={addressl1 + ' ' + addressl2 || ""}
                      />
                    </div>
                  </div>
